...
//                    echo "<script>alert('".$isFollow."')</script>";
                    if($isFriend > 0 || getInforUserById( $_GET["id"])->id == $_SESSION['userid'] || !isset($_SESSION["email"]))
                    ...
                    if($isFollow > 0 || getInforUserById( $_GET["id"])->id == $_SESSION['userid'] || !isset($_SESSION["email"]))
